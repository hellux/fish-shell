...
echo foo >(mktemp my_file-XXX)/some_file
#CHECKERR: warning: An error occurred while redirecting file '{{.*/my_file-...}}/some_file'
#CHECKERR: warning: Path '{{.*/my_file-...}}' is not a directory
